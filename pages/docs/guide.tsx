  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://www.musicdownloader.cc/${locale}/docs/guide`} />
            ...
            __html: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: t('seo:docs.guide.title'),
                  item: `https://www.musicdownloader.cc/${locale}/docs/guide`
                }
              ]
            })
          }}
